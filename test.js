const arrayReorder = require('./')

const test = require('tape')
const tapSpec = require('tap-spec')

test('array-reorder', function(t) {
    t.deepEqual(arrayReorder(new Map([
        [0, 0]
    ...
    t.deepEqual(arrayReorder(new Map(), [1, 2, 3, 4]),
        [1, 2, 3, 4], 'no changes (empty Map)')

    t.deepEqual(arrayReorder(new Map(), []),
        [], 'no changes (empty Map) and empty list')

    t.throws(() => arrayReorder(new Map([
        [0, 2],
        [1, 2]
